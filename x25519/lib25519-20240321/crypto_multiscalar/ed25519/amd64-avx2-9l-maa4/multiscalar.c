...
static void ge25519_double_scalarmult_process_new(ge25519_p3 *r, const signed char (*nslide)[256], const ge25519_pniels (*cP)[P_MULTIPLES], long long num)
{
  ge25519_p1p1 p1p1;
  ge25519_p2 p2;
  ge25519_p3 p3;
...
)
{
  ...
  while (len > 0) {
...

    {
      ...
      ge25519_double_scalarmult_process_new(&u,nslide,cP,todo);
