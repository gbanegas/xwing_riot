...
// linker define clamp012
// linker define clamp254
// linker define twoexp8_p0
// linker define twoexp8_p123
// linker define twoexp8_p4
...
const crypto_uint64 CRYPTO_SHARED_NAMESPACE(mask63) = 0x7FFFFFFFFFFFFFFF;
const crypto_uint64 CRYPTO_SHARED_NAMESPACE(clamp012) = 0xFFFFFFFFFFFFFFF8;
const crypto_uint64 CRYPTO_SHARED_NAMESPACE(clamp254) = 0x4000000000000000;
const crypto_uint64 CRYPTO_SHARED_NAMESPACE(twoexp8_p0) = 0xFFFFFFFFFFFFED00;
const crypto_uint64 CRYPTO_SHARED_NAMESPACE(twoexp8_p123) = 0xFFFFFFFFFFFFFFFF;
const crypto_uint64 CRYPTO_SHARED_NAMESPACE(twoexp8_p4) = 0x000000000000007F;
